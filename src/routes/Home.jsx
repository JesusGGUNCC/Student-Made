  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="w-full h-[50vh] md:h-[60vh] lg:h-[80vh] bg-black text-white flex flex-col items-center justify-center px-4 md:px-8">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-6">Welcome to Niner Mine</h1>
        <p className="text-lg md:text-xl text-center mb-8 max-w-2xl">Discover unique products from UNCC student artisans and vendors</p>
